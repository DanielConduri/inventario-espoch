...
function generarPDFBienesMantenimientoPreventivoPorPlanificacion(contenido, titulo) {
  ...
  return new Promise((resolve, reject) => {
    ...
    doc.setDocumentHeader({ height: 165 }, () => {
      //imagen
...
export default generarPDFBienesMantenimientoPreventivoPorPlanificacion;