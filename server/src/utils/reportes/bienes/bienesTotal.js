...
function generarPDFBienesTotal(contenido, titulo) {
  ...
  return new Promise((resolve, reject) => {
    ...
    doc.addTable(
      [
        { key: "str_codigo_bien_cod", label: " CÓDIGO ", align: "center" , width: 60 },
        { key: "str_catalogo_bien_descripcion", label: "NOMBRE", align: "center", width: 200 },
...
export default generarPDFBienesTotal;