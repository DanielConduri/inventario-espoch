...
function generarPDFFechaCompraAnual(contenido, titulo) {
  ...
  return new Promise((resolve, reject) => {
    ...
    doc.setDocumentHeader({ height: 150 }, () => {
      ...
      doc.moveDown(1);
      doc.text("Cantidad de Bienes por Año", {
        align: "center",
      })
    ...
    doc.addTable(
      [
        { key: "Cantidad", label: "CANTIDAD ADQUIRIDA", align: "center", width:100, },
        { key: "anio", label: "AÑO", align: "center", width:100,},
...
export default generarPDFFechaCompraAnual;