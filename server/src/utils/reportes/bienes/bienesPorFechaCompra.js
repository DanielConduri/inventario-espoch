...
function generarPDFBienesPorFechaCompra(contenido, titulo) {
  ...
  return new Promise((resolve, reject) => {
    ...
    doc.setDocumentHeader({ height: 150 }, () => {
      ...
      doc.text("Desde fecha más antigua a fecha más reciente", {
        align: "center",
      })
...
export default generarPDFBienesPorFechaCompra;